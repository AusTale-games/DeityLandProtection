...
extends AbstractAsyncCommand {
    ...
    protected CompletableFuture<Void> executeAsync(@Nonnull CommandContext ctx) {
        DeityLandProtectionLangPreferenceManager.Language effective;
        ...
        DeityLandProtectionLangPreferenceManager.Language language = effective = ctx.isPlayer() ? this.langPreferenceManager.getEffectiveLanguage(senderId) : defaultLang;
        if (sub.equals("help") || sub.equals("ayuda")) {
            ctx.sendMessage(Message.raw((String)DeityLandProtectionText.helpLang(effective)));
            return CompletableFuture.completedFuture(null);
        }
        if (sub.equals("status") || sub.equals("estado")) {
            ctx.sendMessage(Message.raw((String)DeityLandProtectionText.langStatus(effective, effective, defaultLang, override)));
            return CompletableFuture.completedFuture(null);
        }
        if (sub.equals("clear") || sub.equals("reset")) {
            ...
            ctx.sendMessage(Message.raw((String)DeityLandProtectionText.langOverrideCleared(effective)));
            return CompletableFuture.completedFuture(null);
        }
        if (sub.equals("default")) {
            ...
            if (!this.canChangeDefault(ctx)) {
                ctx.sendMessage(Message.raw((String)DeityLandProtectionText.noPermission(effective)));
                return CompletableFuture.completedFuture(null);
            }
            ...
            ctx.sendMessage(Message.raw((String)DeityLandProtectionText.langDefaultUpdated(effective, newLang)));
            return CompletableFuture.completedFuture(null);
        }
        if (sub.equals("en") || sub.equals("es")) {
            ...
            ctx.sendMessage(Message.raw((String)DeityLandProtectionText.langUpdated(newLang, newLang)));
            return CompletableFuture.completedFuture(null);
        }
        ctx.sendMessage(Message.raw((String)DeityLandProtectionText.helpLang(effective)));
        return CompletableFuture.completedFuture(null);
